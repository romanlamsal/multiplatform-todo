...
// src/initTodoAdapter.ts
var import_dotenv = __toESM(require_main(), 1);
import inquirer from "inquirer";

// ../../packages/todoAdapter/src/createApp.ts
import { initializeApp } from "firebase/app";
import { browserLocalPersistence, initializeAuth } from "firebase/auth";
var createApp = (apiKey) => {
...
// ../../packages/todoAdapter/src/types/Todo.ts
...
var NewTodoSchema = TodoSchema.pick({ value: true, dueDate: true }).extend({
  id: TodoSchema.shape.id.default(() => nanoid()),
  createdAt: TodoSchema.shape.createdAt.default(() => /* @__PURE__ */ new Date()),
  updatedAt: TodoSchema.shape.updatedAt.default(() => /* @__PURE__ */ new Date()),
...
var createTodoApi = (app, onChange) => {
  ...
  onValue(ref(db, "todos"), (snapshot) => {
    ...
    const newTodos = Object.values(snapshotValue).reduce(
      (acc, curr) => {
        ...
        if (!parsedData.success) {
          console.error(`Could not parse loaded todo with id ${curr?.id}: ${parsedData.error}`);
        } else {
...
// ../../packages/todoAdapter/src/createTodoAdapter.ts
var createTodoAdapter = (apiKey, cb) => {
...
USER_PASSWORD=${answers.password}`);
  ...
  const envLocal = import_dotenv.default.parse(readFileSync(dotenvPath));
...
// src/index.ts
var todoAdapterPromise = initTodoAdapter().catch(() => process.exit(1));
var lastMessage = "";
do {
